...
You'll to run migrate if you make changes to your data model that aren't reflected in your existing database. 
...
The Auto generated code live in `node_modules/prisma/prisma-client`. Since this code is auto generated you won't need to work with this directly. 
...
As you work be careful to note which files code apply to. Some code snippets are show but aren't meant to be usesd. 
...
I used `src.script.js` to delete all of by records and start over again. 
...
When you get to the section: Authentication. The tutorial will ask you to an HTTP header in the Graphiql browser. It should look like this: 
...
After completing the tutorial try these challenges: 
